...
public class ConsoleColors {
    ...
    public static String magentaColorMessage(String message) {
        return MAGENTA + message + RESET;
    }

    public static String blueColorMessage(String message) {
        return BLUE + message + RESET;
    }

    public static String colorHeading(String message) {
